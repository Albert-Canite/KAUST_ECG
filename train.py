...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--class_weight_abnormal", type=float, default=1.40)
    ...
    parser.add_argument("--threshold_fpr_penalty", type=float, default=1.5)
    parser.add_argument("--threshold_center", type=float, default=0.80)
    parser.add_argument("--threshold_reg", type=float, default=0.03)
    parser.add_argument("--abnormal_sampler_boost", type=float, default=1.2)
