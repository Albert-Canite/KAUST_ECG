"""Step 02: export P segment (kernel 1 placeholder)."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Step 02: export P segment for kernel 1.")
...
def main() -> None:
    ...
    write_segment_csv(args.output_dir, "01_P_k1.csv", segment, label_text)
