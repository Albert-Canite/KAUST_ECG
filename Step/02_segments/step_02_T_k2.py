"""Step 02: export T segment (kernel 2 placeholder)."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Step 02: export T segment for kernel 2.")
...
def main() -> None:
    ...
    write_segment_csv(args.output_dir, "10_T_k2.csv", segment, label_text)
