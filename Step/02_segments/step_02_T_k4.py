"""Step 02: export T segment (kernel 4 placeholder)."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Step 02: export T segment for kernel 4.")
...
def main() -> None:
    ...
    segment = selected_processed[:, 240:360]
    write_segment_csv(args.output_dir, "12_T_k4.csv", segment, label_text)
