"""Step 02: export QRS segment (kernel 4 placeholder)."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Step 02: export QRS segment for kernel 4.")
...
def main() -> None:
    ...
    segment = selected_processed[:, 120:240]
    write_segment_csv(args.output_dir, "08_QRS_k4.csv", segment, label_text)
