"""Step 02: export P segment (kernel 4 placeholder)."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Step 02: export P segment for kernel 4.")
...
def main() -> None:
    ...
    write_segment_csv(args.output_dir, "04_P_k4.csv", segment, label_text)
