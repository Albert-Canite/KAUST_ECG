"""Step 02: export T segment (kernel 1 placeholder)."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Step 02: export T segment for kernel 1.")
...
def main() -> None:
    ...
    write_segment_csv(args.output_dir, "09_T_k1.csv", segment, label_text)
