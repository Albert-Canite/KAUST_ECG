"""Step 02: export QRS segment (kernel 3 placeholder)."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Step 02: export QRS segment for kernel 3.")
...
def main() -> None:
    ...
    write_segment_csv(args.output_dir, "07_QRS_k3.csv", segment, label_text)
